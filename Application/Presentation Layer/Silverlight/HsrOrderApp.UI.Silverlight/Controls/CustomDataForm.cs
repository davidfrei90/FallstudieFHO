...
using HsrOrderApp.UI.Silverlight.Helpers;

namespace HsrOrderApp.UI.Silverlight.Controls
{
    /// <summary>
    ...
    public class CustomDataForm : DataForm
    {
        ...
        /// <summary>
        ///     Returns a <see cref="System.Collections.Generic.Dictionary{TKey,TValue}" /> containing all the <see cref="DataForm" />
